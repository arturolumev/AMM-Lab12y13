//Codigo lab11 normal:
import 'package:labsintareas/app/model/task.dart';
import 'package:labsintareas/app/view/components/h1.dart';
...
class _TaskListPage extends State<TaskListPage> with SingleTickerProviderStateMixin{
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
               ...
               children: [
                  Text("Hola, el contador es: $count"),
                  SizedBox(height: 16),
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
